      ...
      <div class="info text-white p-3 d-flex flex-column h-100 jc-end">
        ...
        <div class="d-flex jc-between pt-2">
          <div class="scores d-flex ai-center" v-if="model.scores">
            ...
            <span>物理攻击</span>
            <span class="badge bg-blue-1">{{model.scores.attack}}</span>
            <span>魔法攻击</span>
            <span class="badge bg-danger">{{model.scores.magic}}</span>
            <span>防御能力</span>
            <span class="badge bg-dark">{{model.scores.defense}}</span>
          </div>
